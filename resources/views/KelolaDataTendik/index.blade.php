                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        ...
                        <div>
                            ...
                            <a href="{{ route('tendik.export') }}" class="btn btn-success">
        ...
        <form action="{{ route('tendik.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalImportLabel">Import Data Tendik</h5>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            form.action = '/tendik/' + id;
        });

        const table = document.querySelector('#tendikTable tbody');
